  ...
  export default function About(){
      ...
      return(
          <Container style={{zoom:"73%"}}>
        <Grid  direction="row"  container style={{backgroundColor:"black",padding:"2%"}}  justify="space-around"  alignItems="center">
          ...
          <Grid container direction="row"  >
            <Grid item xs={12} sm={12}>
              <img  style={{width:"100%"}} src={Sobre}></img>
            </Grid>
          </Grid>
          </Container>
      )
